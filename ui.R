  ...
  tabPanel("Single-Sample Mode",
    ...
    tabPanel("Batch Mode",
             fluidPage(
               sidebarLayout(
                 sidebarPanel(
                   # This side bar has a button to see upload instructions or Actually upload
                   # if you click upload, then two upload fields are shown 
                   radioButtons("batch_upload_or_instructions", "See instructions or upload data",
                                choices = c("Instructions", "Upload"),
                                selected = "Instructions"),
                   conditionalPanel("input.batch_upload_or_instructions == 'Upload'",
                 ...
                 mainPanel(
                   # this panel shows instructions OR uploaded params info / results
                   conditionalPanel("input.batch_upload_or_instructions == 'Instructions'",
                                    fluidPage(
                   ...
                   conditionalPanel("input.batch_upload_or_instructions == 'Upload'",
                                    ...
                                    conditionalPanel("input.run_batch_mode",
                                                     ...
                                                     HTML("<br>"),
                                                     HTML("Combined Results Table: (appears when analysis is finished)"),
